...
% \includegraphics[width=0.85\columnwidth]{images/analytics_dashboard.png}
\fbox{\parbox{0.8\columnwidth}{\centering\vspace{2cm}\textit{[Insert: Analytics Dashboard Screenshot]}\vspace{2cm}}}
% ==========================================
\caption{Longitudinal Emotion Analytics (LEA) dashboard showing emotion distribution over time, positivity ratio trends, and emotional stability metrics. The visualization helps users recognize patterns in their emotional states.}
\label{fig:analytics}
\end{figure}
...
\centering
% ====== INSERT YOUR SCREENSHOT HERE ======
% \includegraphics[width=0.85\columnwidth]{images/app_chat_interface.png}
\fbox{\parbox{0.8\columnwidth}{\centering\vspace{2cm}\textit{[Insert: App Chat Interface Screenshot]}\vspace{2cm}}}
% ==========================================
\caption{Rebirth mobile application interface showing the conversational UI with real-time emotion detection. Each message displays an emotion badge indicating the detected emotional state with confidence score.}
...
\centering
% ====== INSERT YOUR SCREENSHOT HERE ======
% \includegraphics[width=0.85\columnwidth]{images/emotion_detection_demo.png}
\fbox{\parbox{0.8\columnwidth}{\centering\vspace{2cm}\textit{[Insert: Emotion Detection Demo Screenshot]}\vspace{2cm}}}
% ==========================================
\caption{Emotion detection in action: The application displays detected emotions (sadness, joy, fear, etc.) as color-coded badges on each message, with conversation responses adapted to match the user's emotional state.}
\label{fig:emotion_demo}
\end{figure}
